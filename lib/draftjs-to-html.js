  ...
  */
  ...
  function getEntityMarkup(entityMap, entityKey, text, customEntityTransform) {
    ...
    if (entity.type === 'IMAGE') {
      var alignment = entity.data.alignment === "none" ? "center" : entity.data.alignment;
  ...
  function getBlockMarkup(block, entityMap, hashtagConfig, directional, customEntityTransform) {
    ...
    if (isAtomicEntityBlock(block)) {
      ...
      if (blockTag) {
        ...
        if(blockTag === "pre")
        {
          blockHtml.push("<".concat(blockTag, " style=\"background:#f1f1f1;border-radius:3px;padding: 1px 10px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;\""))
        }
        else {
        ...
        if(blockTag === "pre")
        {
          blockHtml.push("<div style=\"margin:1em\">")
          blockHtml.push(getBlockInnerMarkup(block, entityMap, hashtagConfig, customEntityTransform));
          blockHtml.push("</div>")
          blockHtml.push("</".concat(blockTag, ">")); // </pre>
        }
        else {
          blockHtml.push(getBlockInnerMarkup(block, entityMap, hashtagConfig, customEntityTransform));
          blockHtml.push("</".concat(blockTag, ">")); // </pre> 
